...
const JobDetail = () => {
    ...
    return (
        ...
        <div style={{
            ...
            backgroundPosition: 'center', // Centers the background image // Ensures the div takes the full height of the viewport
        }}>
            ...
            <div style={{
                ...
                <img src={job.job_image} alt={job.title} style={{ width: '400px', height: '400px', borderRadius: '8px' }} />
