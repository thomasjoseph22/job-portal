  ...
  useEffect(() => {
    const fetchJobs = async () => {
      try {
        ...
        console.log(response.data.jobs); // Log to check the structure of jobs
            ...
            {filteredJobs.length > 0 ? (
              filteredJobs.map((job) => (
                <div key={job.id} style={styles.jobCard}>
                  ...
                  <p style={styles.jobCategory}><strong>Category: </strong>{job.category || 'N/A'}</p>
                  <p style={styles.jobLocation}><strong>Location:</strong> {job.location || 'Location not specified'}</p>
