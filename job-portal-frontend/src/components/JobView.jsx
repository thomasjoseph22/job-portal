...
const JobView = () => {
    ...
    useEffect(() => {
        const fetchUserDetails = async () => {
            ...
            try {
                // Fetch user details (e.g., from an API endpoint)
        ...
        // Fetch jobs only if userDetails are set
        const fetchJobs = async () => {
            ...
            try {
                ...
                // Filter jobs based on the company name
        ...
        // Fetch jobs once userDetails are available
        if (userDetails) {
            fetchJobs();
        }
    }, [navigate, userDetails]); // userDetails as a dependency to trigger fetchJobs after it's set
