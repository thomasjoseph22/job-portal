...
from .views import JobListCreateView, JobDetailView, PublicJobListView, TotalJobsView, applied_jobs, apply_for_job, company_applied_jobs, send_application_email, update_job_application_status, update_job_viewed_status
from . import views
...
urlpatterns = [
    ...
    path('jobs/<int:job_id>/viewed/', update_job_viewed_status, name='update_job_viewed_status'),
