...
class CustomUser(AbstractUser):
    ...
    skills = models.JSONField(default=list,null=True, blank=True)  # Store skills as a JSON array
    experience = models.IntegerField(null=True, blank=True)  # Experience in years
